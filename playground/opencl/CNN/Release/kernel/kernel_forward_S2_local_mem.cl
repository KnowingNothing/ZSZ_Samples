__kernel void kernel_forward_S2(__global float *in, __global float *weight,
  ...
  for (int ax0_ax1_fused_ax2_fused_outer_outer_outer = 0;
    ...
    data_shared[((((ax0_ax1_fused_ax2_fused_outer_outer_outer * 4) +
                  ...
                  ((int)get_local_id(0))))] =
        data[(((((((((int)get_group_id(2)) * 784) +
                   (((int)get_group_id(1)) * 112)) +
                  (ax0_ax1_fused_ax2_fused_outer_outer_outer * 28)) +
                 (((int)get_group_id(0)) * 4)) +
                (((int)get_local_id(1)) * 2)) +
               ((int)get_local_id(0))))];
  }
  if (((((int)get_local_id(1)) * 2) + ((int)get_local_id(0))) < 1) {
    if (((int)get_local_id(1)) < 1) {
      weight_shared[(((((int)get_local_id(1)) * 2) + ((int)get_local_id(0))))] =
          weight[((((((int)get_local_id(1)) * 2) + ((int)get_local_id(0))) +
                   ((int)get_group_id(2))))];
    }
  }
      ...
      if (((((int)get_group_id(1)) * 2) + ((int)get_local_id(1))) < 13) {
        if (((((int)get_group_id(0)) * 2) + ((int)get_local_id(0))) < 13) {
          output_local[(0)] =
              (output_local[(0)] +
               (((data_shared[(
                      ((((((int)get_local_id(1)) * 8) + (rr_outer_inner * 4)) +
  ...
  if (((((int)get_group_id(1)) * 2) + ((int)get_local_id(1))) < 13) {
    if (((((int)get_group_id(0)) * 2) + ((int)get_local_id(0))) < 13) {
      output[(
          (((((((int)get_group_id(2)) * 169) + (((int)get_group_id(1)) * 26)) +
             (((int)get_local_id(1)) * 13)) +
