__kernel void kernel_forward_C3(__global float *in, __global float *weight,
  ...
  for (int ax0_ax1_fused_ax2_fused_outer_outer_outer_outer = 0;
       ax0_ax1_fused_ax2_fused_outer_outer_outer_outer < 54;
       ++ax0_ax1_fused_ax2_fused_outer_outer_outer_outer) {
    data_shared[((((ax0_ax1_fused_ax2_fused_outer_outer_outer_outer * 4) +
                   (((int)get_local_id(1)) * 2)) +
                  ((int)get_local_id(0))))] =
        data[((((((((((ax0_ax1_fused_ax2_fused_outer_outer_outer_outer * 4) +
                      (((int)get_local_id(1)) * 2)) +
                     ((int)get_local_id(0))) /
                    36) *
                   196) +
  ...
  for (int ax0_ax1_fused_ax2_fused_ax3_fused_outer_outer_outer_outer = 0;
       ax0_ax1_fused_ax2_fused_ax3_fused_outer_outer_outer_outer < 19;
    ...
    for (int ax0_ax1_fused_ax2_fused_ax3_fused_inner_s = 0;
      ...
      if (((((ax0_ax1_fused_ax2_fused_ax3_fused_outer_outer_outer_outer * 8) +
             (((int)get_local_id(1)) * 4)) +
            (((int)get_local_id(0)) * 2)) +
           ax0_ax1_fused_ax2_fused_ax3_fused_inner_s) < 150) {
        if ((((ax0_ax1_fused_ax2_fused_ax3_fused_outer_outer_outer_outer * 4) +
              (((int)get_local_id(1)) * 2)) +
             ((int)get_local_id(0))) < 75) {
          weight_shared[(
              ((((ax0_ax1_fused_ax2_fused_ax3_fused_outer_outer_outer_outer *
                  8) +
                 (((int)get_local_id(1)) * 4)) +
                (((int)get_local_id(0)) * 2)) +
               ax0_ax1_fused_ax2_fused_ax3_fused_inner_s))] = weight
              ...
              (output_local[(0)] +
               ((data_shared[(((((((rc_outer_inner * 108) + (rc_inner * 36)) +
                 ...
                 weight_shared[(((((rc_outer_inner * 75) + (rc_inner * 25)) +
                                  (rr_outer_inner * 5)) +
                                 rs_inner))]) +
                (bias[(((int)get_group_id(2)))] * 6.666667e-03f)));
        }
      }
    }
  }
  output[((((((((int)get_group_id(2)) * 100) + (((int)get_group_id(1)) * 20)) +
            ...
            (((int)get_group_id(0)) * 2)) +
           ((int)get_local_id(0))))] = tanh(output_local[(0)]);
}
